...
public class GraphQXLSchemaDefinitionImpl extends GraphQXLTypeSystemDefinitionImpl implements GraphQXLSchemaDefinition {

  public GraphQXLSchemaDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GraphQXLOperationTypeDefinitions getOperationTypeDefinitions() {
    return findChildByClass(GraphQXLOperationTypeDefinitions.class);
  }
