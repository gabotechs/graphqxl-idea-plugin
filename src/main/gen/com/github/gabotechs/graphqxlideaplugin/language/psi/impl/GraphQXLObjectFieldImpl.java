...
public class GraphQXLObjectFieldImpl extends GraphQXLNamedElementImpl implements GraphQXLObjectField {

  public GraphQXLObjectFieldImpl(@NotNull ASTNode node) {
    super(node);
  }
