...
public class GraphQXLFieldWithoutArgsImpl extends GraphQXLNamedElementImpl implements GraphQXLFieldWithoutArgs {

  public GraphQXLFieldWithoutArgsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitFieldWithoutArgs(this);
  }
