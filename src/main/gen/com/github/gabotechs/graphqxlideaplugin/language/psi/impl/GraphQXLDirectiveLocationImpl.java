...
public class GraphQXLDirectiveLocationImpl extends GraphQXLElementImpl implements GraphQXLDirectiveLocation {

  public GraphQXLDirectiveLocationImpl(@NotNull ASTNode node) {
    super(node);
  }
