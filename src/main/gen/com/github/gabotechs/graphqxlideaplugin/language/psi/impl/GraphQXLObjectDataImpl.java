...
public class GraphQXLObjectDataImpl extends GraphQXLElementImpl implements GraphQXLObjectData {

  public GraphQXLObjectDataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitObjectData(this);
  }
  ...
  @Override
  @NotNull
  public List<GraphQXLObjectEntry> getObjectEntryList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GraphQXLObjectEntry.class);
  }
