...
public class GraphQXLQuotedStringImpl extends GraphQXLStringLiteralImpl implements GraphQXLQuotedString {

  public GraphQXLQuotedStringImpl(@NotNull ASTNode node) {
    super(node);
  }
