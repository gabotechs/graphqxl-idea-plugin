...
public class GraphQXLUnionExtImpl extends GraphQXLNamedElementImpl implements GraphQXLUnionExt {

  public GraphQXLUnionExtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitUnionExt(this);
  }
