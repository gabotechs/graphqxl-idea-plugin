...
public class GraphQXLFieldsDefinitionImpl extends GraphQXLElementImpl implements GraphQXLFieldsDefinition {

  public GraphQXLFieldsDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GraphQXLFieldDefinition> getFieldDefinitionList() {
