...
public class GraphQXLInterfaceDefImpl extends GraphQXLNamedElementImpl implements GraphQXLInterfaceDef {

  public GraphQXLInterfaceDefImpl(@NotNull ASTNode node) {
    super(node);
  }
