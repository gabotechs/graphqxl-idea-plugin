...
public abstract class GraphQXLTypeDefinitionImpl extends GraphQXLTypeSystemDefinitionImpl implements GraphQXLTypeDefinition {

  public GraphQXLTypeDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
