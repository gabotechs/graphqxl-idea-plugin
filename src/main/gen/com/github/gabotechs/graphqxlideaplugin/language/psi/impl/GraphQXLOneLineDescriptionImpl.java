...
public class GraphQXLOneLineDescriptionImpl extends GraphQXLElementImpl implements GraphQXLOneLineDescription {

  public GraphQXLOneLineDescriptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitOneLineDescription(this);
  }
