...
public class GraphQXLDirectiveRepeatableImpl extends GraphQXLElementImpl implements GraphQXLDirectiveRepeatable {

  public GraphQXLDirectiveRepeatableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitDirectiveRepeatable(this);
  }
