...
public class GraphQXLArrayValueImpl extends GraphQXLValueImpl implements GraphQXLArrayValue {

  public GraphQXLArrayValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GraphQXLValue> getValueList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GraphQXLValue.class);
  }
