...
public class GraphQXLFunctionInputImpl extends GraphQXLElementImpl implements GraphQXLFunctionInput {

  public GraphQXLFunctionInputImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitFunctionInput(this);
  }
