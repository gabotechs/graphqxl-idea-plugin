...
public class GraphQXLImplementsInterfacesImpl extends GraphQXLElementImpl implements GraphQXLImplementsInterfaces {

  public GraphQXLImplementsInterfacesImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GraphQXLTypeName> getTypeNameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GraphQXLTypeName.class);
  }
