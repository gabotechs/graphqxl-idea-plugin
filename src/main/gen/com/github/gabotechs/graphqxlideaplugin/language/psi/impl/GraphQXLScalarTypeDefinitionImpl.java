...
public class GraphQXLScalarTypeDefinitionImpl extends GraphQXLTypeDefinitionImpl implements GraphQXLScalarTypeDefinition {

  public GraphQXLScalarTypeDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
