...
public class GraphQXLFilenameImpl extends GraphQXLElementImpl implements GraphQXLFilename {

  public GraphQXLFilenameImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GraphQXLCharNoDoubleQuote getCharNoDoubleQuote() {
    return findChildByClass(GraphQXLCharNoDoubleQuote.class);
  }
