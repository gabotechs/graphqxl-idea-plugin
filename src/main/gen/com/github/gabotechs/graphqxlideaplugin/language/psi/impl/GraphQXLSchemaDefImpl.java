...
public class GraphQXLSchemaDefImpl extends GraphQXLElementImpl implements GraphQXLSchemaDef {

  public GraphQXLSchemaDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitSchemaDef(this);
  }
  ...
  @Override
  @Nullable
  public GraphQXLSchemaSelectionSet getSchemaSelectionSet() {
    return findChildByClass(GraphQXLSchemaSelectionSet.class);
  }
