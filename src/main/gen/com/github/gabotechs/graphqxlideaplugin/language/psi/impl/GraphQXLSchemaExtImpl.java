...
public class GraphQXLSchemaExtImpl extends GraphQXLElementImpl implements GraphQXLSchemaExt {

  public GraphQXLSchemaExtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitSchemaExt(this);
  }
