...
public class GraphQXLBlockStringImpl extends GraphQXLStringLiteralImpl implements GraphQXLBlockString {

  public GraphQXLBlockStringImpl(@NotNull ASTNode node) {
    super(node);
  }
