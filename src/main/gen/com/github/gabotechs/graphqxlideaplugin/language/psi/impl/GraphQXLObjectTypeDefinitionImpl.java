...
public class GraphQXLObjectTypeDefinitionImpl extends GraphQXLTypeDefinitionImpl implements GraphQXLObjectTypeDefinition {

  public GraphQXLObjectTypeDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
