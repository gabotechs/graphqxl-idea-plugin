...
public class GraphQXLScalarDefImpl extends GraphQXLNamedElementImpl implements GraphQXLScalarDef {

  public GraphQXLScalarDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitScalarDef(this);
  }
