...
public class GraphQXLGenericInputDefImpl extends GraphQXLNamedElementImpl implements GraphQXLGenericInputDef {

  public GraphQXLGenericInputDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitGenericInputDef(this);
  }
