...
public class GraphQXLScalarExtImpl extends GraphQXLNamedElementImpl implements GraphQXLScalarExt {

  public GraphQXLScalarExtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitScalarExt(this);
  }
