...
public class GraphQXLCharNoDoubleQuoteImpl extends GraphQXLElementImpl implements GraphQXLCharNoDoubleQuote {

  public GraphQXLCharNoDoubleQuoteImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitCharNoDoubleQuote(this);
  }
