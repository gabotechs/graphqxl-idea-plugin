...
public class GraphQXLBooleanDataImpl extends GraphQXLElementImpl implements GraphQXLBooleanData {

  public GraphQXLBooleanDataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitBooleanData(this);
  }
