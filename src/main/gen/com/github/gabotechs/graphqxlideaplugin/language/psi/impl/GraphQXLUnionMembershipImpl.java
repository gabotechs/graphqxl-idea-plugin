...
public class GraphQXLUnionMembershipImpl extends GraphQXLElementImpl implements GraphQXLUnionMembership {

  public GraphQXLUnionMembershipImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GraphQXLUnionMembers getUnionMembers() {
    return findChildByClass(GraphQXLUnionMembers.class);
  }
