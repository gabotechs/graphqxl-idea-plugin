...
public class GraphQXLArgumentsImpl extends GraphQXLElementImpl implements GraphQXLArguments {

  public GraphQXLArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GraphQXLArgument> getArgumentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GraphQXLArgument.class);
  }
