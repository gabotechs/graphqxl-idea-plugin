...
public class GraphQXLFieldWithoutArgsWithoutValueImpl extends GraphQXLNamedElementImpl implements GraphQXLFieldWithoutArgsWithoutValue {

  public GraphQXLFieldWithoutArgsWithoutValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitFieldWithoutArgsWithoutValue(this);
  }
