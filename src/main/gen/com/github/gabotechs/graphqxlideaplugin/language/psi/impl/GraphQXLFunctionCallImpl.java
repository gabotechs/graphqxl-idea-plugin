...
public class GraphQXLFunctionCallImpl extends GraphQXLElementImpl implements GraphQXLFunctionCall {

  public GraphQXLFunctionCallImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GraphQXLFunctionInput> getFunctionInputList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GraphQXLFunctionInput.class);
  }
