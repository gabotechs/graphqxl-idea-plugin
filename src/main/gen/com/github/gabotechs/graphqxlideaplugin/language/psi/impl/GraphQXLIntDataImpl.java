...
public class GraphQXLIntDataImpl extends GraphQXLElementImpl implements GraphQXLIntData {

  public GraphQXLIntDataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitIntData(this);
  }
