...
public abstract class GraphQXLStringLiteralImpl extends GraphQXLElementImpl implements GraphQXLStringLiteral {

  public GraphQXLStringLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
