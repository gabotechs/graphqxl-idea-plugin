...
public class GraphQXLSelectionImpl extends GraphQXLElementImpl implements GraphQXLSelection {

  public GraphQXLSelectionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GraphQXLField getField() {
    return findNotNullChildByClass(GraphQXLField.class);
  }
