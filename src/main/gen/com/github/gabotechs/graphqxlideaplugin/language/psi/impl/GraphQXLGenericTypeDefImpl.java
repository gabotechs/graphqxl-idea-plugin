...
public class GraphQXLGenericTypeDefImpl extends GraphQXLNamedElementImpl implements GraphQXLGenericTypeDef {

  public GraphQXLGenericTypeDefImpl(@NotNull ASTNode node) {
    super(node);
  }
