...
public class GraphQXLMultilineDescriptionImpl extends GraphQXLElementImpl implements GraphQXLMultilineDescription {

  public GraphQXLMultilineDescriptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitMultilineDescription(this);
  }
