...
public class GraphQXLRequiredModifierImpl extends GraphQXLElementImpl implements GraphQXLRequiredModifier {

  public GraphQXLRequiredModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitRequiredModifier(this);
  }
