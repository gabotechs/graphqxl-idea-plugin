...
public class GraphQXLArgumentsDefinitionImpl extends GraphQXLElementImpl implements GraphQXLArgumentsDefinition {

  public GraphQXLArgumentsDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
