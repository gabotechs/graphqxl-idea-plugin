...
public class GraphQXLTypeNameDefinitionImpl extends GraphQXLNamedElementImpl implements GraphQXLTypeNameDefinition {

  public GraphQXLTypeNameDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
