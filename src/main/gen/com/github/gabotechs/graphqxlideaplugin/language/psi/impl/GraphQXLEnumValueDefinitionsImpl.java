...
public class GraphQXLEnumValueDefinitionsImpl extends GraphQXLElementImpl implements GraphQXLEnumValueDefinitions {

  public GraphQXLEnumValueDefinitionsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GraphQXLEnumValueDefinition> getEnumValueDefinitionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GraphQXLEnumValueDefinition.class);
  }
