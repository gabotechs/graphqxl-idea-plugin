...
public class GraphQXLSchemaFieldImpl extends GraphQXLElementImpl implements GraphQXLSchemaField {

  public GraphQXLSchemaFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitSchemaField(this);
  }
  ...
  @Override
  @NotNull
  public GraphQXLSchemaKey getSchemaKey() {
    return findNotNullChildByClass(GraphQXLSchemaKey.class);
  }
