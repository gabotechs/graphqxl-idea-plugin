...
public class GraphQXLValueNonNullableImpl extends GraphQXLElementImpl implements GraphQXLValueNonNullable {

  public GraphQXLValueNonNullableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitValueNonNullable(this);
  }
