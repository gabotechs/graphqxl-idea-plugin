...
public class GraphQXLValueDataImpl extends GraphQXLElementImpl implements GraphQXLValueData {

  public GraphQXLValueDataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitValueData(this);
  }
