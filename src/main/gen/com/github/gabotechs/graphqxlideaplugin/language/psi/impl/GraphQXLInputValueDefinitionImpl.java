...
public class GraphQXLInputValueDefinitionImpl extends GraphQXLNamedElementImpl implements GraphQXLInputValueDefinition {

  public GraphQXLInputValueDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GraphQXLDefaultValue getDefaultValue() {
    return findChildByClass(GraphQXLDefaultValue.class);
  }
