...
public class GraphQXLFieldImpl extends GraphQXLNamedElementImpl implements GraphQXLField {

  public GraphQXLFieldImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GraphQXLAlias getAlias() {
    return findChildByClass(GraphQXLAlias.class);
  }
  ...
  @Override
  @Nullable
  public GraphQXLSelectionSet getSelectionSet() {
    return findChildByClass(GraphQXLSelectionSet.class);
  }
