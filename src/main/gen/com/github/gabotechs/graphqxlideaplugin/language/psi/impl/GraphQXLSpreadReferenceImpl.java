...
public class GraphQXLSpreadReferenceImpl extends GraphQXLElementImpl implements GraphQXLSpreadReference {

  public GraphQXLSpreadReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitSpreadReference(this);
  }
  ...
  public GraphQXLModifiedRef getModifiedRef() {
    return findNotNullChildByClass(GraphQXLModifiedRef.class);
  }
