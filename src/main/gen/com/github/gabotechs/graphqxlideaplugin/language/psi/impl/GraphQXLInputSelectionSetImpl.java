...
public class GraphQXLInputSelectionSetImpl extends GraphQXLElementImpl implements GraphQXLInputSelectionSet {

  public GraphQXLInputSelectionSetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphQXLVisitorBase visitor) {
    visitor.visitInputSelectionSet(this);
  }
