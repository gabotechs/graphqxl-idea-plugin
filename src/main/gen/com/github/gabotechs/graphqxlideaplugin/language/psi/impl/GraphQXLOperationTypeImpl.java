...
public class GraphQXLOperationTypeImpl extends GraphQXLElementImpl implements GraphQXLOperationType {

  public GraphQXLOperationTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
